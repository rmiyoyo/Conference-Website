...
<div align="center">
  <br/>
  <h3><b>InnovationX Africa Summit</b></h3>
</div>
...
This project is a website built using HTML, CSS, and JavaScript to promote and provide information about the ***InnovationX Africa Summit***. The website includes details about the conference, such as the schedule, speakers, registration, and sponsorship opportunities.

The website is designed with a modern, clean, and intuitive user interface to ensure a seamless user experience for visitors. We believe that technology has the power to transform Africa, and we are committed to creating a platform that enables individuals and organizations to connect, learn, and innovate.
...
- You can find the website [here](https://rmiyoyo.github.io/Conference-Website/)
